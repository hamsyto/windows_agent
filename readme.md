...
usb и вставить по умному в архитектуру
...
- чтобы не перекомпилировать добавить в setting тип type (дефолт - work). он будет проверяться и в зависимости от типа выполнять разный код
